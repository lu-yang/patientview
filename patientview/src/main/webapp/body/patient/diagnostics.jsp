...
<div class="row">
    <div class="span12">
        ...
        <table class="table table-bordered table-striped paragraphSizeTopMargin">
            ...
            <tbody>
            <logic:iterate name="diagnosticsImaging" id="image" type="org.patientview.renalpatientview.patientview.model.Diagnostic">
                <tr>
                    <td>
        ...
        <table class="table table-bordered table-striped paragraphSizeTopMargin">
            ...
            <tbody>
            <logic:iterate name="diagnosticsEndoscopy" id="endoscopy" type="org.patientview.renalpatientview.patientview.model.Diagnostic">
                <tr>
                    <td>
