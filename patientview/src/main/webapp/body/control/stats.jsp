    ...
    <logic:notEmpty name="unitstats">
        ...
        <logic:present name="unit">
            ...
            <table cellpadding="3" border="0" class="table table-striped table-bordered table-condensed table-massive">
                ...
                <logic:iterate name="unitstats" id="stat" type="org.patientview.renalpatientview.patientview.unitstat.UnitMonthStats">
                <tr>
                    <td width="23%" class="tablecellbold"><b><bean:write name="stat" property="yearmonth"/></b></td>

                    <logic:iterate name="statsHeadings" id="heading" type="org.patientview.renalpatientview.patientview.unitstat.StatsHeading">
