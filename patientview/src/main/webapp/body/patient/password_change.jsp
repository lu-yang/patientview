...
<logic:present name="passwordError">
    <bean:message key="errors.header"/><bean:message key="errors.prefix"/><bean:message
        key="oldpassword.incorrect"/><bean:message key="errors.suffix"/><bean:message key="errors.footer"/>
</logic:present>

<logic:present name="emailError">
    <bean:message key="errors.header"/><bean:message key="errors.prefix"/><bean:message
        key="emailAddress.required"/><bean:message key="errors.suffix"/><bean:message key="errors.footer"/>
</logic:present>
...
<html:form action="/patient/passwordChange" styleClass="form-horizontal">

<div class="control-group">
    <label class="control-label">Username</label>

    <div class="controls"><%= LegacySpringUtils.getSecurityUserManager().getLoggedInUsername() %>
    </div>
</div>
...
<% if (LegacySpringUtils.getSecurityUserManager().isFirstLogon()
    ...
    <div class="control-group">
        ...
        <div class="controls"><html:text property="emailAddress"
                                         value="<%= LegacySpringUtils.getSecurityUserManager().getLoggedInEmailAddress() %>"/></div>
    </div>

    <div class="control-group">
        <label class="control-label">Confirm Email Address</label>

        <div class="controls"><html:text property="emailAddressAgain"/></div>
    </div>
...
<div class="control-group">
    ...
    <div class="controls"><input type="password" id="passwordPwd" name="passwordPwd" autocomplete="off"
...
<table id="tablePwdStatus" cellpadding="5" cellspacing="1" border="0"
       class="pwdmeter table table-bordered table-striped">
<tr>
    ...
    <td colspan="6" class="pwdmeter">
        <ul id="listLegend">
            ...
            <li>
                ...
                <span class="bold">Warning:</span> Advisory against employing bad practices. Overall score is
                reduced.
            </li>
            <li>
