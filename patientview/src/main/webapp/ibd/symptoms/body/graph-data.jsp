...
<%@ page import="org.patientview.renalpatientview.ibd.model.symptoms.SymptomsData" %>
...
<bean:define id="symptomsGraphData" name="graphData" type="org.patientview.renalpatientview.ibd.model.symptoms.SymptomsGraphData" />
<%
    String scoresString = "";
    String datesString = "";
