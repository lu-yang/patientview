<%@ page import="org.patientview.renalpatientview.ibd.Ibd" %>
            ...
            <div id="medicationContainer" <%=(medicationTypeId <= 0 ? "class=\"hidden\"":"")%>>
                <div class="control-group">
                    ...
                    <div class="controls" id="medicationLists">
                        <logic:iterate name="medicationTypeList" id="medicationType" type="org.patientview.renalpatientview.ibd.model.medication.MedicationType">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <logic:iterate name="medicationTypeList" id="medicationType">
                                ...
                                <logic:iterate name="medications" id="medication" type="org.patientview.renalpatientview.ibd.model.medication.Medication">
