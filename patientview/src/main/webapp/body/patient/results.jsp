                ...
                <logic:notEqual value="true" name="panel" property="currentPanel">
                    <li >
                        <html:link action="/patient/results"  paramId="panel" paramName="panel" paramProperty="panel" styleClass="tooltip-link"><bean:write name="panel" property="panel" />
                            <span class="tooltip">
                                <logic:iterate name="panel" property="resultHeadings" id="heading" type="org.patientview.renalpatientview.patientview.model.ResultHeading" >
...
<td colspan="10"><img src="images/space.gif"/></td>
    ...
    <logic:notEmpty name="results">
        ...
        <logic:present name="user">
            ...
            <logic:iterate name="results" id="result" type="org.patientview.renalpatientview.patientview.Result" length="resultsPerPage" offset="resultsOffset" >
                <tr>
                    ...
                    <logic:iterate name="resultsHeadings" id="heading" type="org.patientview.renalpatientview.patientview.model.ResultHeading" >
