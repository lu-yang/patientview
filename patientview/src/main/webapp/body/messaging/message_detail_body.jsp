...
<%@ page import="org.patientview.renalpatientview.patientview.model.Specialty" %>
<%@ page import="org.patientview.renalpatientview.patientview.model.User" %>
            ...
            <section class="js-messages">
                <logic:present name="messages">
                    <logic:notEmpty name="messages">
                        <logic:iterate name="messages" id="message" indexId="index" type="org.patientview.renalpatientview.patientview.model.Message">
