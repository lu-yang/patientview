    ...
    private class DiagnosisRowMapper implements RowMapper<Diagnosis> {
        public Diagnosis mapRow(ResultSet resultSet, int i) throws SQLException {
            ...
            diagnosis.setMutationYorN1(
                    getEnumValue(Diagnosis.MutationYorN.class, resultSet.getInt("MUTATION_1")));
            diagnosis.setMutationYorN2(
                    getEnumValue(Diagnosis.MutationYorN.class, resultSet.getInt("MUTATION_2")));
            diagnosis.setMutationYorN3(
                    getEnumValue(Diagnosis.MutationYorN.class, resultSet.getInt("MUTATION_3")));
            diagnosis.setMutationYorN4(
                    getEnumValue(Diagnosis.MutationYorN.class, resultSet.getInt("MUTATION_4")));
            diagnosis.setMutationYorN5(
                    getEnumValue(Diagnosis.MutationYorN.class, resultSet.getInt("MUTATION_5")));
            diagnosis.setMutationYorN6(
                    getEnumValue(Diagnosis.MutationYorN.class, resultSet.getInt("MUTATION_6")));
            diagnosis.setMutationYorN7(
                    getEnumValue(Diagnosis.MutationYorN.class, resultSet.getInt("MUTATION_7")));
            diagnosis.setMutationYorN8(
                    getEnumValue(Diagnosis.MutationYorN.class, resultSet.getInt("MUTATION_8")));
            diagnosis.setMutationYorN9(
                    getEnumValue(Diagnosis.MutationYorN.class, resultSet.getInt("MUTATION_9")));

            // Mutation S
            diagnosis.setMutationSorSN1(
                    getEnumValue(Diagnosis.MutationSorSN.class, resultSet.getInt("MUTATION_1S")));
            diagnosis.setMutationSorSN2(
                    getEnumValue(Diagnosis.MutationSorSN.class, resultSet.getInt("MUTATION_2S")));
            diagnosis.setMutationSorSN3(
                    getEnumValue(Diagnosis.MutationSorSN.class, resultSet.getInt("MUTATION_3S")));
            diagnosis.setMutationSorSN4(
                    getEnumValue(Diagnosis.MutationSorSN.class, resultSet.getInt("MUTATION_4S")));
            diagnosis.setMutationSorSN5(
                    getEnumValue(Diagnosis.MutationSorSN.class, resultSet.getInt("MUTATION_5S")));
            diagnosis.setMutationSorSN6(
                    getEnumValue(Diagnosis.MutationSorSN.class, resultSet.getInt("MUTATION_6S")));
            diagnosis.setMutationSorSN7(
                    getEnumValue(Diagnosis.MutationSorSN.class, resultSet.getInt("MUTATION_7S")));
            diagnosis.setMutationSorSN8(
                    getEnumValue(Diagnosis.MutationSorSN.class, resultSet.getInt("MUTATION_8S")));
            diagnosis.setMutationSorSN9(
                    getEnumValue(Diagnosis.MutationSorSN.class, resultSet.getInt("MUTATION_9S")));
            ...
            diagnosis.setBiopsyProvenDiagnosis(
                    getEnumValue(Diagnosis.BiopsyDiagnosis.class, getIntegerWithNullCheck("BX_PROVEN_DIAG"
                            , resultSet)));
            ...
            diagnosis.setParentalConsanguinity(
                    getEnumValue(Diagnosis.YesNo.class, resultSet.getInt("CONSANGUINITY")));
            diagnosis.setFamilyHistory(getEnumValue(Diagnosis.YesNo.class, resultSet.getInt("FAM_HIST")));

            diagnosis.setSteroidResistance(
                    getEnumValue(Diagnosis.SteroidResistance.class, resultSet.getInt("STEROID_RESIST")));
