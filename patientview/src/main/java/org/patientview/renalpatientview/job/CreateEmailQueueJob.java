 ...
 */
package org.patientview.renalpatientview.job;

import org.patientview.renalpatientview.batch.CreateEmailQueueReader;
import org.patientview.renalpatientview.patientview.model.EmailQueue;
...
public class CreateEmailQueueJob extends BatchJob {
    ...
    private List<org.patientview.renalpatientview.patientview.model.Job> jobs;
    ...
    protected void onJobSkipInWriter(Object holder, Throwable problem) {
        ...
        if (holder instanceof EmailQueue) {
            ...
            org.patientview.renalpatientview.patientview.model.Job job = emailQueue.getJob();
    ...
    protected void onRunError(Exception e) {
        ...
        if (jobs != null) {
            for (org.patientview.renalpatientview.patientview.model.Job job : jobs) {
     ...
     * @param jobs
     */
    protected void updateJobStatusFailded(List<org.patientview.renalpatientview.patientview.model.Job> jobs) {
    ...
    private void updateJobStatusSucceeded(List<org.patientview.renalpatientview.patientview.model.Job> jobs) {
