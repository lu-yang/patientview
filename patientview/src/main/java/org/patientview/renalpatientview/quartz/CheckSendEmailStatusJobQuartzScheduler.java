 ...
 */
package org.patientview.renalpatientview.quartz;

import org.patientview.renalpatientview.job.CheckSendEmailStatusJob;
...
public class CheckSendEmailStatusJobQuartzScheduler extends BaseQuartzScheduler {
   ...
   @Override
    protected void setJob() {
       super.setBatchJob(checkSendEmailStatusJob);
    }
}
